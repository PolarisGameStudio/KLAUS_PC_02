...
namespace Com.LuisPedroFonseca.ProCamera2D
{
    ...
    public class MoveInColliderBoundaries
    {
        ...
        public Vector3 Move(Vector3 deltaMovement)
        {
            ...
            // Set camera as bounded
            _proCamera2D.IsCameraPositionHorizontallyBounded = false;
            if(_cameraCollisionState.HBottomLeft || 
                _cameraCollisionState.HBottomRight ||
                _cameraCollisionState.HTopLeft ||
                _cameraCollisionState.HTopRight)
            _proCamera2D.IsCameraPositionHorizontallyBounded = true;

            _proCamera2D.IsCameraPositionVerticallyBounded = false;
            if(_cameraCollisionState.VBottomLeft || 
                _cameraCollisionState.VBottomRight ||
                _cameraCollisionState.VTopLeft ||
                _cameraCollisionState.VTopRight)
            _proCamera2D.IsCameraPositionVerticallyBounded = true;
